/**
 * Deckathon Registration Automation Script (Playwright Version)
 * 
 ...
 * 
 * Uses rebrowser-playwright for anti-detection bypass.
 * 
 * Features:
...
const { firefox } = require('rebrowser-playwright');
...
const CONFIG = {
    ...
    WATERFOX_PATH: process.env.WATERFOX_PATH || 'C:\\Program Files\\Waterfox\\waterfox.exe',
...
async function registerOnDeckathon() {
    ...
    try {
        console.log('Starting Deckathon Registration Script (Playwright)\n');
        ...
        browser = await firefox.launch({
            headless: false,
            executablePath: CONFIG.WATERFOX_PATH,
            args: [
                '-width', '1920',
                '-height', '1080'
            ]
